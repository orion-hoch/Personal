    ...
    tabs: [
      {
        ...
        items: [
...

          {
            ...
            imageLabel: 'Project Image',
            image: '/images/project/gauntlet.png',
    ...
    tabs: [
      {
        ...
        items: [
          {
            title: 'Sports Trivia Balatro',
            visualizationStepId: 'creative-trivia-overview',
            imageLabel: 'Project Image',
            href: 'https://oriontrivia.org',
            external: true,
            description: 'A deckbuilding roguelike where you collect NFL and NBA player-season cards and build hands scored through position patterns, joker modifiers, and combo rules. Ships with 100+ unique jokers with cascading effects, shop items, packs, and relic synergies — all driven by a shared SQLite sports database with draft history, Pro Bowl awards, and team divisions as game rules.',
            skills: ['Python', 'Flask', 'SvelteKit', 'SQLite', 'Game Design'],
          },
          {
            title: 'Sports Trivia Multiplayer Draft Games',
            visualizationStepId: 'creative-trivia-overview',
            imageLabel: 'Project Image',
            href: 'https://oriontrivia.org',
            external: true,
            description: 'Local multiplayer draft modes (Fantasy Duel, Starting 6, Starting 5) where players compete to name roster members then choose season versions. NFL uses positional rosters; NBA uses position groups. Serverless state is persisted through Vercel KV with TTL-based expiry to handle stateless request cycles cleanly.',
            skills: ['Python', 'FastAPI', 'SvelteKit', 'Vercel KV', 'Multiplayer'],
          },
          {
            title: 'Sports Trivia Chain and Deduction Games',
            visualizationStepId: 'creative-trivia-overview',
            imageLabel: 'Project Image',
            href: 'https://oriontrivia.org',
            external: true,
            description: 'Two distinct trivia modes: Chain Game, an intersection puzzle where answers must satisfy multiple simultaneous category constraints (wrong guesses reveal which constraints passed); and Ticking Time Bomb, a fast deduction game where missed guesses reveal teammate clues. All game rules are validated server-side for fairness; the frontend owns feel and animation.',
            skills: ['Python', 'Flask', 'SvelteKit', 'SQLite', 'Game Systems'],
          },
          {
